        ...
        {filteredProducts.map((product, index) => (
          ...
          >
            ...
            <div className="flex flex-col mx-2 my-2">
              ...
              <button className="self-start my-2 border-[2px] border-gray-400 rounded-lg px-2 py-1 cursor-pointer font-medium hover:bg-green-500/80 hover:border-green-500/80 hover:text-white">
                Read More
              </button>
            </div>
          </div>
